...
// ---------------------------------------------
var burn_raster = ee.Image("projects/rsapp-data-exploration/assets/burned-area-aug-to-oct-2015");
...
var endDate   = '2015-12-31';  // 2 month composite
...
Export.image.toDrive({
  image: medianEVI,
  description: 'Landsat_Post_Fire_EVI',
  folder: 'rsapp-data-GEE',
  region: burn_raster,
  scale: 30,
  crs: 'EPSG:4326',
  maxPixels: 1e13
